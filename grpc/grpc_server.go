...
func SearchPath(pn int64, amount int64) ([]string, map[string]pbClient.AgreeRequestsMessage) {
	...
	/* composing p */
	p = []string{
		"D03A2CC08755eC7D75887f0997195654b928893e",
		"0b4161ad4f49781a821C308D672E6c669139843C",
		"78902c58006916201F65f52f7834e467877f0500"}
	...
	cps1 = append(cps1, &pbClient.ChannelPayment{ChannelId: int64(1), Amount: -amount})
	...
	cps2 = append(cps2, &pbClient.ChannelPayment{ChannelId: int64(1), Amount: amount})
	cps2 = append(cps2, &pbClient.ChannelPayment{ChannelId: int64(2), Amount: -amount})
	...
	cps3 = append(cps3, &pbClient.ChannelPayment{ChannelId: int64(2), Amount: amount})
...
func SearchPath2222(pn int64, amount int64) ([]string, map[string]pbClient.AgreeRequestsMessage) {
	var p []string
	...
	for i := 0; i < len(channels); i++ {
		if channels[i].From == "D03A2CC08755eC7D75887f0997195654b928893e" {
			channelID1 = int64(channels[i].ChannelId)
		} else if channels[i].From == "0b4161ad4f49781a821C308D672E6c669139843C" {
